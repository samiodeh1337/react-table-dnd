/**
 * Example: Scrollable cell content — rows with horizontally and vertically scrollable cells.
 * Demonstrates that touch scroll inside a cell scrolls the cell first, then overflows to the table.
 */
...
function ScrollableCell({ children }) {
  return <div style={scrollCellStyle}>{children}</div>
}
