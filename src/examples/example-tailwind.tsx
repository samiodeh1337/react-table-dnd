...
const thStyle: React.CSSProperties = {
  display: "flex", alignItems: "center", height: 42, padding: "0 16px",
  fontSize: 12, fontWeight: 600, color: "#9ca3af", background: "#111827",
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <TableContainer options={options} onDragEnd={handleDragEnd}
        style={{ height: 420, borderRadius: 12, overflow: "hidden", border: "1px solid #374151", background: "#111827" }}>
        <TableHeader>
          {cols.map((col, i) => (
